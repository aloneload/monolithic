package monolithic.repository;

import monolithic.MonolithicApp;
import monolithic.config.Constants;
import monolithic.config.audit.AuditEventConverter;
import monolithic.domain.PersistentAuditEvent;
...
import static monolithic.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
